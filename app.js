...
initEventListeners(){
    ...
    O login.js agora controla:
    - validação
    - sessão
    - autenticação

    O app.js apenas recebe o evento.
    */
